...
| **Last completed slice** | **Mobile date input stability (2026-08-03)** — 16px inputs prevent iOS zoom; calendar portal + viewport-aware positioning; report period sheet on mobile. |
| **Last commit/tag**      | `v0.mobile-date-input` |
