...
- [x] File-size ratchet: split export UI/APIs for expenses, reports/GL books, expenses-review, general-ledger, supplier activity; baseline lowered (expenses/api 464, reports/api 512, GL 539; supplier + expenses-review off list).
