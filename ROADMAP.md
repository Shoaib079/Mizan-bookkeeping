...
| **Last completed slice** | **Banking account creation routes (2026-08-01)** — cash drawer + FX wallet off “Add bank account”; **Add cash drawer** on Banking → Cash; FX wallets on FX hub only; bank/card forms locked to kind. |
| **Last commit/tag**      | `v0.banking-account-kinds` |
