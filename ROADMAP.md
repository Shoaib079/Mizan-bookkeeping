...
| ---------- | ----------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-05 | BSF-2 — Supplier advances (pay-first)           | (pending)                                              | Allow negative AP = advance; soft confirm above threshold (`supplier_advance_confirm_threshold_kurus`, default ₺1k); auto-apply + classify skip confirm; UI labels; 10+ pytest (+1003 green; 7 pre-existing unrelated failures) |
