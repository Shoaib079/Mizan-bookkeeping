...
| **Last completed slice** | **Balances hub totals fix (2026-07-31)** — Cash & bank from account tree (no credit cards); Staff TRY-only total + FX note; Partner hint accurate. Vitest + tsc green. |
| **Last commit/tag**      | `v0.balances-hub-totals` — Balances overview card totals |
