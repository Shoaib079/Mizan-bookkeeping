...
| -------------------------------------------------------------------------------- | ------------------------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Prominent tabs & filter chips (segment track on all section pages)               | `v0.prominent-tabs`                               | pending tag    | Restore underline SectionTabs; tiny FilterChips; hand-roll delivery/payment pickers |
