...
| ---------- | ----------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-05 | Statement classify post without page flash      | (pending)                                              | Patch classified line in place via API response; no `loading` refetch on post/correct; classify bar + ledger stay mounted; vitest |
