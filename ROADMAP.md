...
| **Last commit/tag**      | feat(expenses): show account names (Turkish) instead of GL codes                                             |
| **Next up**              | See **`POST_LAUNCH_PLAN.md`** — P2 AI auto-categorize · P3 uploads backup · P5 delete-company · P6 full production |
