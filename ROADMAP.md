...
| **Active slice**         | *(none — cash/bank column-sep awaiting review)* |
| **Next up**              | Owner review → push when approved; else POST_LAUNCH_PLAN queue |
| **Last completed slice** | **Cash & bank card — column separation + bold subtotals** (`v0.dashboard-cash-bank-column-sep`) |
| **Last commit/tag**      | `v0.dashboard-cash-bank-column-sep` |
