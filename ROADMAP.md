...
| **Active slice**         | *(none)* |
| **Next up**              | Continue FE file-size splits (manual-expense / salary payment / …) per `FRONTEND_AUDIT_REPORT.md`; per-menu period report deferred |
| **Last completed slice** | **Split invoice-draft review** (`v0.fe-split-invoice-draft`) |
| **Last commit/tag**      | `v0.fe-split-invoice-draft` |
