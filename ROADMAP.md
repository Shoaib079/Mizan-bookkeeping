...
| **Active slice**         | *(none)* |
| **Next up**              | Continue FE file-size splits (salary payment / opening balances / …) per `FRONTEND_AUDIT_REPORT.md`; per-menu period report deferred |
| **Last completed slice** | **Split manual-expense form** (`v0.fe-split-manual-expense`) |
| **Last commit/tag**      | `v0.fe-split-manual-expense` |
