...
| **Last completed slice** | **Frontend npm audit clean (2026-08-01)** — npm overrides pin patched postcss + sharp inside Next 15.5.22; 0 high vulnerabilities (do not use `npm audit fix --force`). |
| **Last commit/tag**      | `v0.npm-audit-overrides` |
