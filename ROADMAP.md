...
| **Last completed slice** | **Record upload file handoff (2026-08-01)** — bank statement from Upload carries file into import mapper (no re-upload); Add Document confirm no longer clears routed file; invoice/receipt/POS modals keep `initialFile` on open. |
| **Last commit/tag**      | `v0.record-upload-handoff` |
