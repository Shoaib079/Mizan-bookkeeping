...
| ---------- | ----------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-05 | Staff salary payment Add hub picker             | (pending)                                              | Route `staffPayment` through staff picker → `StaffSalaryPaymentDialog` with real employee; guard `isValidStaffSalaryEmployee`; remove `"Employee"` placeholder leak; statement classify resolves name; vitest + 1026 pytest |
