...
| `backend/tests/test_tips.py` | Tips are a cash EXPENSE (Slice A + H2) — `5700` in default chart; cash posts `Dr 5700 / Cr cash`; bank + `5700` → 422 at posting boundary and API | pass |
...
| `frontend/src/lib/app-routes.test.ts` | Sidebar nav groups — plain-language sections, Settings sub-pages, Sales/Cards grouping, Reports nesting | pass |
