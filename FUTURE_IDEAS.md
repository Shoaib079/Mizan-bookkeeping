...
- **Statement classify bar slim-down** — *owner 2026-09-01.* **Mobile stack shipped** (`v0.statement-classify-mobile`): stacked type/who/Post on phone, hide empty target, hide bank-fee tip on phone. Still open (desktop + further slim): ~22 classifications in one list; progressive “Learn as”; dual UIs (banking classify bar vs Review row actions). Not bounce.
