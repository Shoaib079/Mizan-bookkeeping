...
/** Unified statement review hub — all lines, inline actions. */
...
export default function StatementReviewPage() {
  ...
  return (
    <>
      <div className="mb-6">
        <h1 className="text-lg font-semibold">Statement review</h1>
        <p className="text-sm text-muted-foreground">
          Review bank and card statement lines — confirm suggestions, correct
          auto-posted entries, and manage suppliers inline.
        </p>
      </div>
