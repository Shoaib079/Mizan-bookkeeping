...
export const appRoutes: AppRoute[] = [
  ...
  },
  {
    href: "/customers",
    label: "Customers",
    keywords: "customer directory receivables credit sales agencies",
    icon: UserCircle,
    group: "Money in",
  },
  {
  ...
  { href: "/reports", label: "Reports", icon: BarChart3, group: "Understand" },
  {
    href: "/settings/restaurant",
    label: "Settings",
    keywords: "settings restaurant team features opening balances backups",
    icon: Settings,
    group: "Understand",
  },
  {
...
const SIDEBAR_GROUP_DEFS = [
  ...
  { label: "Money in", icon: ShoppingBag },
  { label: "Money out", icon: Wallet },
  { label: "Money held", icon: Building2 },
