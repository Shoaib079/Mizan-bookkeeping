...
class JournalEntrySource(str, enum.Enum):
    ...
    POS_CARD_TIP = "pos_card_tip"
    POS_COMMISSION_SWEEP = "pos_commission_sweep"
    POS_COMMISSION_STATEMENT = "pos_commission_statement"
    ...
    PARTNER_PROFIT_ALLOCATION = "partner_profit_allocation"
    PARTNER_PROFIT_PAID = "partner_profit_paid"
    PARTNER_SUPPLIER_PAID = "partner_supplier_paid"
    EXPENSE_PERSONAL_SPLIT = "expense_personal_split"
